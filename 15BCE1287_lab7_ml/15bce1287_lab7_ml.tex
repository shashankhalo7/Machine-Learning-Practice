...
\title{Multi Layer Perceptron on Breast Cancer Wisconsin dataset}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=3.5in,height=2in]{1_5.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=2.5in,height=0.7in]{1_3.png}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\label{fig_error}
...
\end{figure}  
where  $ \mathbf{w}$ denotes the vector of weights,  $ \mathbf{x}$ is the vector of inputs, $ b$ is the bias and $ \varphi$ is the activation function
...
'ClumpThickness', 'UCellSize', 'UCellShape','MargAdhes', 'EpiCellSize', 'BareNuc', 'Chromatin', 'Nucleoli' and 'Mitoses'. After this I did some preprocessing i.e. scaling the data and taking the standardized values.After this I trained the Neural Network for 1000 epochs and  Then I plotted the graps between costs and epochs using matplotlib   

\begin{figure}[H]
\centering
\includegraphics[width=3.5in,height=2.5in]{2_!.png}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\caption{}
...
\begin{figure}[H]
\centering
\includegraphics[width=3.5in,height=2.5in]{2_2.png}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\caption{}
...
\section{Conclusion}
After the classification we can see that the classification was  very effective,.This indeed suggest that the MLP model is ver apt to classifify the data into two class Benign and Malignant for the breast cancer dataset
The system developed performs with 96.65\% insample accuracy and 97.56\% accuracy for the  test sample in a two class classification\\
