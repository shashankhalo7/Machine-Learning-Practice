...
\title{A study on Gausian Mixture Model}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=3.5in,height=2in]{2_2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=2.5in,height=0.7in]{2_1.png}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\label{fig_error}
...
Gaussian distributions give flexibility to the clustering, and the same basic two step E-M algorithm used in K-Means is applied here as well.Randomly initialize location and shapeAfter this Repeat until converged:there are 2 steps E-step: for each point, find weights encoding the probability of membership in each cluster.and M-step: for each cluster, update its location, normalization, and shape based on all data points, making use of the weights
...
\begin{figure}[H]
\centering
\includegraphics[width=3.5in,height=2.5in]{2_3.png}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\caption{}
...
\begin{figure}[H]
\centering
\includegraphics[width=3.5in,height=2.5in]{2_4.png}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\caption{}
...
\section{Conclusion}
After this experiments we understood how the expectation maximization algorithm works and how Gausian mixture models works.We also realized that how GMM can used as a tool for Density estimator\\
