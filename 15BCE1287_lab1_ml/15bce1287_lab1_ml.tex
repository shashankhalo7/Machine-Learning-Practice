...
\title{Preprocessing on Breast Cancer Dataset}
...
% in the abstract
\begin{abstract}
	Today’s  real-world  dataset  are highly  susceptible  to  noisy,  missing,  and  inconsistent  data due to their typically huge size (often several gigabytes or more) and their likely origin from multiple, heterogenous sources.So this low-quality data will lead to error-prone learning
results.In order to making learning more efficient we should preprocess this data to remove noise,missing values and inconsistency. 
\\
...
\section{Experiments}
First we will analyse the data usinf the pairplot function in seaborn library to plot a figure as shown in fig.2

\begin{center}[H]
sb.pairplot(df,vars=cols,hue='Class')
\end{center}	
\begin{figure}
\centering
\includegraphics[width=3.5in,height=4in]{2.png}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\caption{Pair Plot Between different attributes}
\label{fig_error}
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=3.5in,height=2.5in]{4_1.png}
	% where an .eps filename suffix will be assumed under latex, 
	% and a .pdf suffix will be assumed for pdflatex; or what has been declared
	% via \DeclareGraphicsExtensions.
	\caption{Histogram}
...
\begin{figure}
	\centering
	\includegraphics[width=3.5in,height=3in]{6.png}
	% where an .eps filename suffix will be assumed under latex, 
	% and a .pdf suffix will be assumed for pdflatex; or what has been declared
	% via \DeclareGraphicsExtensions.
	\caption{Violin Plot}
...
\begin{figure}
\centering
\includegraphics[width=3.5in,height=3in]{7.png}
% where an .eps filename suffix will be assumed under latex, 
% and a .pdf suffix will be assumed for pdflatex; or what has been declared
% via \DeclareGraphicsExtensions.
\caption{Box Plot}
